...
Port 21/TCP was open, executing vsftpd 2.3.4.

Risk Assessment

Version 2.3.4 contains a well-known malicious backdoor embedded in its source archive, presenting a Critical threat due to the potential for remote code execution.
